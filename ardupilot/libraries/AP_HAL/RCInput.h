...
public:
	...
	// my_source
	virtual void my_source_lib_rc_init(void) = 0;
	virtual int my_source_lib_rc_orb_check(int handle, bool * updated) = 0;
	virtual void my_source_lib_rc_update_pwm(uint16_t values, int ch) = 0;
	virtual void my_source_lib_rc_display(void) = 0;
	virtual void my_source_lib_rc_set_pwm(void) = 0;
};
