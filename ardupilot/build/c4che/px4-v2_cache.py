...
CXX_TGT_F = ['-c', '-o']
DEBUG = False
DEFINES = ['SKETCHBOOK="/home/jj/ardupilot"', 'CONFIG_HAL_BOARD=HAL_BOARD_PX4', 'HAVE_OCLOEXEC=0', 'HAVE_STD_NULLPTR_T=0', 'UAVCAN_CPP_VERSION=UAVCAN_CPP03', 'UAVCAN_NO_ASSERTIONS=1', 'UAVCAN_NULLPTR=nullptr']
DEFINES_ST = '-D%s'
...
DSDL_COMPILER = '/home/jj/ardupilot/modules/uavcan/libuavcan/dsdl_compiler/libuavcan_dsdlc'
DSDL_COMPILER_DIR = '/home/jj/ardupilot/modules/uavcan/libuavcan/dsdl_compiler'
GIT = ['/usr/bin/git']
GIT_SUBMODULES = ['PX4Firmware', 'PX4NuttX', 'uavcan', 'mavlink']
HAS_GTEST = False
INCLUDES = ['/home/jj/ardupilot/libraries/', '/home/jj/ardupilot/libraries/AP_Common/missing', '/home/jj/ardupilot/modules/uavcan/libuavcan/include']
...
MAKE = ['/usr/bin/make']
MAVGEN = '/home/jj/ardupilot/modules/mavlink/pymavlink/tools/mavgen.py'
MAVLINK_DIR = '/home/jj/ardupilot/modules/mavlink'
PREFIX = '/usr/local'
PX4IO_ELF_DEST = 'px4-extra-files/px4io'
PX4_ADD_GIT_HASHES = '/home/jj/ardupilot/Tools/scripts/add_git_hashes.py'
PX4_APM_ROOT = '/home/jj/ardupilot'
PX4_BOARD_NAME = 'px4fmu-v2'
PX4_BOARD_RC = False
PX4_BOOTLOADER = '/../bootloader/px4fmuv2_bl.bin'
PX4_BOOTLOADER_NAME = 'px4fmuv2_bl.bin'
PX4_CMAKE_VARS = {'PX4_NUTTX_ROMFS': '/home/jj/ardupilot/build/px4-v2/px4-extra-files/ROMFS', 'EXTRA_CXX_FLAGS': '-Wno-error=double-promotion -Wno-error=reorder -DCMAKE_BUILD -DARDUPILOT_BUILD -I/home/jj/ardupilot/build/px4-v2/libraries/GCS_MAVLink -I/home/jj/ardupilot/build/px4-v2/libraries/GCS_MAVLink/include/mavlink -Wl,--gc-sections', 'CONFIG': 'nuttx_px4fmu-v2_apm', 'CMAKE_MODULE_PATH': '/home/jj/ardupilot/Tools/ardupilotwaf/px4/cmake', 'EXTRA_C_FLAGS': '-DCMAKE_BUILD', 'NUTTX_SRC': '/home/jj/ardupilot/modules/PX4NuttX', 'ARDUPILOT_BUILD': 'YES'}
PX4_NUTTX_ROOT = '/home/jj/ardupilot/modules/PX4NuttX'
PX4_PARAM_DEFAULTS = None
PX4_PX4IO_NAME = 'px4io-v2'
PX4_ROMFS_BLD = 'px4-extra-files/ROMFS'
PX4_ROMFS_SRC = 'mk/PX4/ROMFS'
PX4_ROOT = '/home/jj/ardupilot/modules/PX4Firmware'
PYC = 1
PYFLAGS = ''
PYFLAGS_OPT = '-O'
PYO = 1
...
cfg_files = ['/home/jj/ardupilot/build/px4-v2/ap_config.h']
cprogram_PATTERN = '%s'
